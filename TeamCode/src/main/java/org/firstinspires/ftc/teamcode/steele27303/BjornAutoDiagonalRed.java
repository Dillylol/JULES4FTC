...
@Autonomous(name = "Bjorn Auto - Diagonal RED (-15, +15)", group = "Auto")
public class BjornAutoDiagonalRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("Initialized. Diagonal RED (-15, +15).");
        telemetry.update();
